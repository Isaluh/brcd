...
//         if (parar.classList.contains('tocando')) {
//             tocar.forEach((parar) => {
//                 parar.setAttribute('src', './assets/play.svg')
//                 parar.classList.remove('tocando')
//             })
//         }
//     })
// })
...
// tocar.forEach((tocarUm) => {
//     tocarUm.addEventListener('click', () => {
//         if (tocarUm.classList.contains('play')) {
//             tocar.forEach((tocarUm) => {
//                 tocarUm.classList.add('hidden')
//             })
//         }
//     })
// })

// pausar.forEach((pausarUm) => {
//     pausarUm.addEventListener('click', () => {
//         if (pausarUm.classList.contains('pause')) {
//             pausar.forEach((pausarUm) => {
//                 pausarUm.classList.add('hidden')
//                 tocarUm.classList.remove('hidden')
//             })
//         }
//     })
// })

// const pausar = document.querySelectorAll("img.pause")

// for (const tocarUm of tocar) {
//     tocarUm.addEventListener('click', () => {
//         for (const pausarUm of pausar) {
//             tocarUm.classList.add('hidden')
//             pausarUm.classList.remove('hidden')
//         }
//     })
// }
